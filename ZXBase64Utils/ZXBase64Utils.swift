...
//var ZX_BASE64_KEYS = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/" //标准字符集
var ZX_BASE64_KEYS = "!@#ef456$%^&*hijkl()]ßmnop∂ƒ©˙∫∆abcd3789gqrstu[}{><œ∑åvwxyz012+/" //自定义字符集 不要包含 `=` , 不要重复 , 共64个字符


extension String {
    func zx_base64Encode() -> String {
        let mString = self
